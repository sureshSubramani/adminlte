                        ...
                        <div id="msform">
                            ...
                            <fieldset id='user'>
                                ...
                                <div class="form-card">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <input type="email" id='email' name="email" class='form-control col-md-4' placeholder="Email" required /> 
                                            <input type="text" id='phone' name="phone" class='form-control col-md-4' maxlength='10' placeholder="+91" required/> 
                                        </div>                                                                     
                                    </div>
                                </div> 
                            </form>
